...
public class SimDataDto
{
    ...
    (Id, Device, Latitude, Longitude, Date, UTCTime, Altitude, Speed, Course, Battery, Signal) =
    (Sim7600DataItem.Id, Sim7600DataItem.Device, Sim7600DataItem.Latitude, Sim7600DataItem.Longitude,
